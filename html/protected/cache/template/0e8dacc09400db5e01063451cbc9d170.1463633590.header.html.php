...
function clearCache(){
  $.ajax({
    type: "post",
    dataType: "text",
    url: "<?php echo url(array('m'=>$MOD, 'c'=>'main', 'a'=>'cleanup', ));?>",
...
<div class="header" id="header">
  <div class="logo fl"><a href="<?php echo url(array('m'=>$MOD, 'c'=>'main', 'a'=>'panel', ));?>">Dubhe Panel</a></div>
  <div class="top-links fr cut">
    <a title="前端首页" class="icon front" target="_blank" href="<?php echo url(array('c'=>'main', 'a'=>'index', ));?>">前端首页</a>
    <a title="帮助文档" class="icon help" href="#" target="_blank">帮助文档</a>
...
<div class="acpop hide" id="pop-user"> <a class="close" onClick="closeUser()">×</a>
  <h2 class="c999">登录用户: <font class="f14 c666 ml5"><?php echo htmlspecialchars($admin['username'], ENT_QUOTES, "UTF-8"); ?></font></h2>
